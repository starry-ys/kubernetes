...
#>>> 安装必要的依赖软件包
yum -y install yum-utils device-mapper-persistent-data lvm2 wget psmisc vim net-tools telnet git ntpdate
if [ $? -eq 0 ];then
...
# sed -i 's#download.docker.com#mirrors.hiops.icu/docker-ce#' /etc/yum.repos.d/docker-ce.repo
